export const SITE = {
  ...
  // SEO/OG значения по умолчанию.
  description:
    'Приз_КитБот — бесплатный бот для честных розыгрышей и конкурсов в мессенджере MAX: проверка подписки, антибот, мультипризовые розыгрыши и аналитика канала.',
  locale: 'ru_RU',
  ogImage: 'logo.jpg',
};
...
export const FEATURES = [
  ...
  { icon: ICON_TREND, title: 'Рост канала', text: 'Мультиканальные розыгрыши со спонсорами приводят новых подписчиков.' },
